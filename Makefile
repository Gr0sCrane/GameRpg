...
SRCS = src/main.cpp src/game_function.cpp src/board.cpp src/classes.cpp src/entity_spawn.cpp src/combat.cpp src/entity.cpp src/player.cpp src/mob.cpp src/algorithm.cpp
OBJS = $(SRCS:.cpp=.o)
TARGET = game.exe
